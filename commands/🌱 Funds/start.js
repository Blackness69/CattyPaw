...
module.exports = {
  ...
  async execute({ msg }) {
    try {
      ...
      const collector = termsMessage.createMessageComponentCollector({ filter, time: 40000 });
